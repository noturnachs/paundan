    ...
    <div className="min-h-screen bg-gray-950 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -inset-[10%] blur-3xl opacity-30">
          <div className="absolute top-0 -left-4 w-96 h-96 bg-purple-600 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"></div>
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            {movie && (
              <Button
                ...
                className="mt-4"
              >
                {loading ? "Generating..." : "Generate Another Movie"}
              </Button>
            )}
          </div>
        </div>
